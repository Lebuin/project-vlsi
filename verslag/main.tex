...
We simuleren het 1-bit schuifregister bij deze frequentie. Er treden problemen op bij volgende situatie: We leggen een hoog ingangssignaal aan, waardoor $V_{tussen}$ in de eerste klokfase laag wordt. Wanneer $V_{in}$ daalt tijdens de tweede klokfase, wordt $V_{tussen}$ ongedefinieerd ($\approx \SI{1,5}{V}$). Dit is weergegeven in \ref{fig:wave_tussen1}. De omgekeerde transitie levert geen problemen op, zoals te zien in \ref{fig:wave_tussen2}.
